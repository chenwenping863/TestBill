...
public class PinnedSectionListView extends ListView {
    ...
    public interface ListBottomListener {
        void loadMore();
    }
    private ListBottomListener mListBottomListener;

    public void setListBottomListener(ListBottomListener listBottomListener) {
        this.mListBottomListener = listBottomListener;
    }
    ...
    private final OnScrollListener mOnScrollListener = new OnScrollListener() {
        ...
        public void onScrollStateChanged(AbsListView view, int scrollState) {
            ...
            if ((view.getLastVisiblePosition() == view.getCount() - 1) && (scrollState == SCROLL_STATE_IDLE || scrollState == SCROLL_STATE_FLING)) {
                mListBottomListener.loadMore();
            }
        }
